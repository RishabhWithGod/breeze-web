...
/**
 * One priced line of one project's vendor rate list, exactly as written.
 *
 * Never edited and never summarised — see {@see ProjectRateItem}, which is
 * derived from these rows and is what an estimate actually quotes.
 */
class ProjectRateLine extends Model
{
    // Read-only history: a line is written once, at import.
    public $timestamps = false;

    protected $fillable = [
        'project_rate_import_id', 'project_id', 'section', 'subsection',
    ...
    /** @return BelongsTo<ProjectRateImport, $this> */
    public function import(): BelongsTo
    {
        return $this->belongsTo(ProjectRateImport::class, 'project_rate_import_id');
    }
